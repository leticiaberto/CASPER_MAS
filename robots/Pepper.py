...
class Pepper(Agent):
    def __init__(self, id, skill_weights, contexts, role, teamsize, run_id, use_sim, agent_agnostic=True, workspace=None, party_duration: float = 3600.0, guests: int = 0):
        constraints={
            "can_move": True,
        ...
        super().__init__(id, constraints, skill_weights, contexts, role, teamsize, party_duration, guests, run_id)
